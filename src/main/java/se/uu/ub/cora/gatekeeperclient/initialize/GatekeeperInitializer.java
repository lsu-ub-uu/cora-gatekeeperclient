...
package se.uu.ub.cora.gatekeeperclient.initialize;
...
import se.uu.ub.cora.gatekeeperclient.dependency.GatekeeperInstanceProvider;
import se.uu.ub.cora.gatekeeperclient.dependency.GatekeeperLocator;
import se.uu.ub.cora.gatekeeperclient.dependency.GatekeeperLocatorImp;
...
public class GatekeeperInitializer implements ServletContextListener {
	...
	private void createInstanceOfUserPickerFactoryClass(String userPickerFactoryString)
			throws InstantiationException, IllegalAccessException, ClassNotFoundException {
		userPickerFactory = (UserPickerFactory) Class.forName(userPickerFactoryString)
				.newInstance();
	}
